...
<button type="button" class="navyBtn" onClick="location.href='allSearch.jsp'">수강편람</button>

<div class="container">
    <div class="col-lg-4"></div>
    <div class="col-lg-4">
        <div class="jumbotron" style="padding-top: 20px;">
            <form method="post" action="classSearch.jsp">
...
<div class="container">
    ...
    <div class="col-lg-4">
        <div class="jumbotron" style="padding-top: 20px;">
            <form method="post" action="lecSearch.jsp">
                <div class="form-group">
...
<div class="container">
    ...
    <div class="col-lg-4">
        <div class="jumbotron" style="padding-top: 20px;">
            <form method="post" action="classNameSearch.jsp">
                <div class="form-group">
