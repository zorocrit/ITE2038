...
<div class="container">
    ...
    <div class="col-lg-4">
        <div class="jumbotron" style="padding-top: 20px;">
            <form method="post" action="ILTwo2.jsp">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="두번째 요일" name="ToneDate" maxlength="20">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="두번째 시작 시간" name="ToneStart1" maxlength="20">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="두번째 시작 분" name="ToneStart2" maxlength="20">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="두번째 끝 시간" name="ToneEnd1" maxlength="20">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="두번째 끝 분" name="ToneEnd2" maxlength="20">
                </div>
