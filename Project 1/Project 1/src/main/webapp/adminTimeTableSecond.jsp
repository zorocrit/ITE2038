...
<head>
  ...
  <title>관리자 전용 학생 수업 시간표 조회</title>
</head>
<body>
...
String lec = request.getParameter("stuID");
    ...
    Statement stmt = null;
    try {
        String sql = "SELECT class.name, time.begin, time.end FROM application left join class on class.class_id = application.class_id left join time on time.class_id = class.class_id where student_id = " + lec;
